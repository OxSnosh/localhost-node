...
export type AccessControllerSetEventFilter =
  TypedEventFilter<AccessControllerSetEvent>;
...
export interface FeedRegistryAbi extends BaseContract {
  ...
  getPhase(
    ...
    phaseId: PromiseOrValue<BigNumberish>,
    overrides?: CallOverrides
  ): Promise<FeedRegistryInterface.PhaseStructOutput>;
  ...
  filters: {
    "AccessControllerSet(address,address)"(
      accessController?: PromiseOrValue<string> | null,
    ...
    "FeedConfirmed(address,address,address,address,uint16,address)"(
      ...
      denomination?: PromiseOrValue<string> | null,
      latestAggregator?: PromiseOrValue<string> | null,
      previousAggregator?: null,
      nextPhaseId?: null,
      sender?: null
    ): FeedConfirmedEventFilter;
    FeedConfirmed(
      asset?: PromiseOrValue<string> | null,
      denomination?: PromiseOrValue<string> | null,
      latestAggregator?: PromiseOrValue<string> | null,
    ...
    "FeedProposed(address,address,address,address,address)"(
      asset?: PromiseOrValue<string> | null,
      denomination?: PromiseOrValue<string> | null,
      proposedAggregator?: PromiseOrValue<string> | null,
      currentAggregator?: null,
      sender?: null
    ): FeedProposedEventFilter;
    FeedProposed(
      asset?: PromiseOrValue<string> | null,
      denomination?: PromiseOrValue<string> | null,
      proposedAggregator?: PromiseOrValue<string> | null,
