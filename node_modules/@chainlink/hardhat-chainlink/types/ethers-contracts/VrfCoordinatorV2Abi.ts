...
export declare namespace VRFCoordinatorV2 {
  ...
  export type RequestCommitmentStruct = {
  ...
  export type RequestCommitmentStructOutput = [
    BigNumber,
    BigNumber,
    number,
    number,
...
export interface VrfCoordinatorV2AbiInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [VRF.ProofStruct, VRFCoordinatorV2.RequestCommitmentStruct]
  ): string;
  encodeFunctionData(
...
export type ProvingKeyDeregisteredEventFilter =
  TypedEventFilter<ProvingKeyDeregisteredEvent>;
...
export type ProvingKeyRegisteredEventFilter =
  TypedEventFilter<ProvingKeyRegisteredEvent>;
...
export interface VrfCoordinatorV2Abi extends BaseContract {
  ...
  functions: {
    ...
    fulfillRandomWords(
      proof: VRF.ProofStruct,
      rc: VRFCoordinatorV2.RequestCommitmentStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    getFeeTier(
      reqCount: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[number]>;
    ...
    setConfig(
      ...
      feeConfig: VRFCoordinatorV2.FeeConfigStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    ): ProvingKeyDeregisteredEventFilter;
    ...
    "ProvingKeyRegistered(bytes32,address)"(
      keyHash?: null,
      oracle?: PromiseOrValue<string> | null
    ): ProvingKeyRegisteredEventFilter;
