...
import type {
  FeedRegistryAbi,
  FeedRegistryAbiInterface,
} from "../FeedRegistryAbi";
...
export class FeedRegistryAbi__factory {
  static readonly abi = _abi;
  static createInterface(): FeedRegistryAbiInterface {
    return new utils.Interface(_abi) as FeedRegistryAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): FeedRegistryAbi {
    return new Contract(address, _abi, signerOrProvider) as FeedRegistryAbi;
  }
}
