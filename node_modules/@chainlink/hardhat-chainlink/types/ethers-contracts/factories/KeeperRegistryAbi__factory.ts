...
import type {
  KeeperRegistryAbi,
  KeeperRegistryAbiInterface,
  ConfigStruct,
} from "../KeeperRegistryAbi";
...
export class KeeperRegistryAbi__factory {
  static readonly abi = _abi;
  static createInterface(): KeeperRegistryAbiInterface {
    return new utils.Interface(_abi) as KeeperRegistryAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): KeeperRegistryAbi {
    return new Contract(address, _abi, signerOrProvider) as KeeperRegistryAbi;
  }
}
