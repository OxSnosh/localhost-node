...
import type {
  ...
  AccessControlledOffchainAggregatorAbiInterface,
} from "../AccessControlledOffchainAggregatorAbi";
...
export class AccessControlledOffchainAggregatorAbi__factory {
  static readonly abi = _abi;
  static createInterface(): AccessControlledOffchainAggregatorAbiInterface {
    return new utils.Interface(
      _abi
    ) as AccessControlledOffchainAggregatorAbiInterface;
  }
  static connect(
    address: string,
