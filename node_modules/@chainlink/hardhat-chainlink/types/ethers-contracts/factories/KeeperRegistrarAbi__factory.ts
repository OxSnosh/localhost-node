...
import type {
  KeeperRegistrarAbi,
  KeeperRegistrarAbiInterface,
} from "../KeeperRegistrarAbi";
...
export class KeeperRegistrarAbi__factory {
  static readonly abi = _abi;
  static createInterface(): KeeperRegistrarAbiInterface {
    return new utils.Interface(_abi) as KeeperRegistrarAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): KeeperRegistrarAbi {
    return new Contract(address, _abi, signerOrProvider) as KeeperRegistrarAbi;
  }
}
